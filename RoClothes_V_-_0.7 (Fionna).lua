...
function RoClothes(Player)
	...
	function Function.PartListDefault()
		return {
			...
			["School Collor"] = {
				...
				["Color"] = {
					["Tone"] = "Base",
					["Color"] = Color3.fromRGB(11, 100, 170)
				},
				["Parent"] = {
					[1] = "Torso",
					[2] = "School Shirt",
	...
	GUIObject.Screen.Name = "RoClothes (Fionna)"
	...
	GUIObject.NameText.Text = "RoClothes (Fionna)"
